...
const InlineAutoComplete = (0, react_1.forwardRef)(({ label, onChange, getData = () => __awaiter(void 0, void 0, void 0, function* () { return []; }), data = [], errors, required = false, name, fullWidth = false, placeholder, id, type = 'custom_select', selectedItems: propsSeelctedItems = [], readOnly = false, disabled = false, value, isMultiple = false, desc = 'name', descId = 'id', singleSelect, className, async = false, paginationEnabled, initialLoad, actionLabel, handleAction, nextBlock, notDataMessage, onFocus, hideClose, }, ref) => {
    ...
    const [dropdownStyle, setDropdownStyle] = (0, react_1.useState)({ top: 0, left: 0 });
    ...
    (0, react_1.useEffect)(() => {
        ...
        scrollableDivs.forEach((div) => div.addEventListener('scroll', handleClickOutside));
        return () => {
            document.removeEventListener('mousedown', handleClickOutside);
            scrollableDivs.forEach((div) => div.removeEventListener('scroll', handleClickOutside));
            window.addEventListener('scroll', handleClickOutside);
        };
    }, []);
    (0, react_1.useEffect)(() => {
        ...
        const getRowPositions = () => rows.map((row) => row.getBoundingClientRect());
    ...
    return (react_1.default.createElement("div", { className: fullWidth ? 'fullWidth' : 'autoWidth', ref: dropdownRef },
        ...
        react_1.default.createElement("div", { style: { position: 'relative' } },
            ...
            react_1.default.createElement("input", { id: id, ref: inputRef, type: "text", value: type === 'auto_suggestion'
                ...
                // onBlur={handleBlur}
                style: { height: 22, minHeight: 22 }, onFocus: adjustDropdownPosition, onClick: () => handleOnClick(), className: generateClassName(), placeholder: (selectedItems === null || selectedItems === void 0 ? void 0 : selectedItems.length) > 0 ? '' : placeholder !== null && placeholder !== void 0 ? placeholder : '', readOnly: readOnly || type === 'custom_select' || type == 'auto_suggestion', disabled: disabled, "data-testid": "custom-autocomplete" }),
            ...
            dropOpen &&
                react_dom_1.default.createPortal(react_1.default.createElement("ul", { ref: dropRef, style: Object.assign(Object.assign({}, dropdownStyle), { minHeight: 240 }), className: `qbs-autocomplete-suggestions` },
                    ...
                    react_1.default.createElement("div", { className: "qbs-autocomplete-suggestions-sub" },
                        (filteredData === null || filteredData === void 0 ? void 0 : filteredData.length) > 0 ? (filteredData.map((suggestion, idx) => (react_1.default.createElement("div", { key: idx.toString(), className: `qbs-autocomplete-listitem-container ${(isMultiple || singleSelect) &&
                            ...
                            react_1.default.createElement("li", { key: idx, className: `qbs-autocomplete-suggestions-item ${isSelected(suggestion, selected)
                                    ? 'is-selected'
                                    : ''}`, onClick: () => handleSuggestionClick(suggestion), "data-testid": suggestion[desc] }, suggestion[desc]))))) : (react_1.default.createElement(react_1.default.Fragment, null, isLoading ? (react_1.default.createElement("div", { style: { display: 'flex', justifyContent: 'center' } },
