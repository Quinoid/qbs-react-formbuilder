...
var InlineAutoComplete = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var _1 = (0, react_1.useState)({ top: 0, left: 0 }), dropdownStyle = _1[0], setDropdownStyle = _1[1];
    ...
    (0, react_1.useEffect)(function () {
        ...
        var scrollableDivs = document.querySelectorAll('div[style*="overflow"]');
        scrollableDivs.forEach(function (div) {
            return div.addEventListener('scroll', handleClickOutside);
        });
        return function () {
            document.removeEventListener('mousedown', handleClickOutside);
            scrollableDivs.forEach(function (div) {
                return div.removeEventListener('scroll', handleClickOutside);
            });
            window.addEventListener('scroll', handleClickOutside);
        };
    }, []);
    (0, react_1.useEffect)(function () {
        var intervalId = null;
        var rows = Array.from(document.querySelectorAll('.rs-table-row'));
        var getRowPositions = function () {
            return rows.map(function (row) { return row.getBoundingClientRect(); });
        };
        var previousPositions = getRowPositions();
        var checkRowMovement = function () {
            var currentPositions = getRowPositions();
            for (var i = 0; i < currentPositions.length; i++) {
                var prev = previousPositions[i];
                var curr = currentPositions[i];
                if (Math.abs(prev.top - curr.top) > 2 ||
    ...
    return (react_1.default.createElement("div", { className: fullWidth ? 'fullWidth' : 'autoWidth', ref: dropdownRef },
        ...
        react_1.default.createElement("div", { style: { position: 'relative' } },
            ...
            react_1.default.createElement("input", { id: id, ref: inputRef, type: "text", value: type === 'auto_suggestion'
                ...
                // onBlur={handleBlur}
                style: { height: 22, minHeight: 22 }, onFocus: adjustDropdownPosition, onClick: function () { return handleOnClick(); }, className: generateClassName(), placeholder: (selectedItems === null || selectedItems === void 0 ? void 0 : selectedItems.length) > 0 ? '' : placeholder !== null && placeholder !== void 0 ? placeholder : '', readOnly: readOnly || type === 'custom_select' || type == 'auto_suggestion', disabled: disabled, "data-testid": "custom-autocomplete" }),
            react_1.default.createElement("div", { className: "qbs-autocomplete-close-icon" },
                (inputValue || searchValue) &&
                    !disabled &&
                    !readOnly &&
                    !hideClose && (react_1.default.createElement("button", { onClick: handleClear, className: "icon-button", "aria-label": "clear" },
            ...
            dropOpen &&
                react_dom_1.default.createPortal(react_1.default.createElement("ul", { ref: dropRef, style: __assign(__assign({}, dropdownStyle), { minHeight: 240 }), className: "qbs-autocomplete-suggestions" },
                    ...
                    react_1.default.createElement("div", { className: "qbs-autocomplete-suggestions-sub" },
                        (filteredData === null || filteredData === void 0 ? void 0 : filteredData.length) > 0 ? (filteredData.map(function (suggestion, idx) { return (react_1.default.createElement("div", { key: idx.toString(), className: "qbs-autocomplete-listitem-container ".concat((isMultiple || singleSelect) &&
                            ...
                            react_1.default.createElement("li", { key: idx, className: "qbs-autocomplete-suggestions-item ".concat(isSelected(suggestion, selected)
                                    ? 'is-selected'
                                    : ''), onClick: function () { return handleSuggestionClick(suggestion); }, "data-testid": suggestion[desc] }, suggestion[desc]))); })) : (react_1.default.createElement(react_1.default.Fragment, null, isLoading ? (react_1.default.createElement("div", { style: { display: 'flex', justifyContent: 'center' } },
                        ...
                        paginationEnabled &&
                            ...
                            react_1.default.createElement("p", { style: { margin: 2 } }, "Load More"))))), document.body)),
...
exports.default = react_1.default.memo(InlineAutoComplete);
//# sourceMappingURL=InlineAutoComplete.js.map