...
export const ArrowIcon: React.FC<any> = ({ className = '' }) => {
  return (
    <svg
...
export const ThreeDot: React.FC<any> = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={`${className}`}
...
export const SectionIcon: React.FC<any> = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const DuplicateIcon: React.FC<any> = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
